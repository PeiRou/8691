...
public class Seller_visitorBean {
	public Seller_visitorBean(String FEIN, String name, String acc_email, String psd, Blob Seller_photo,
			String tel, String GUAR_CT, String GUAR_AR, String GUAR_AR_name, String GUAR_NO,String email2, 
	...
	public String toString() {
		return "Seller_visitorVO [FEIN=" + FEIN + ", name=" + name + ", acc_email=" + acc_email + ", psd=" + psd
				+ ", Seller_photo=" + Seller_photo + ", tel=" + tel + ", GUAR_CT=" + GUAR_CT + ", GUAR_AR=" + GUAR_AR
				+ ", GUAR_AR_name=" + GUAR_AR_name + ", GUAR_NO=" + GUAR_NO + ", email2=" + email2 + ", Con_name=" + Con_name
