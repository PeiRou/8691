...
public class _13_UpdateStatusDAOjdbc {
	...
	// "jdbc:sqlserver://raab1str2m.database.windows.net:1433;database=DB02";
	...
	public static void main(String[] args) {
		...
		// select
		// MemberBean beanSelect =
		// dao.select("87B6061E-4C34-4F1A-843F-032EC7D44125");
		...
		// insert
		// MemberBean beanIns = new
		// MemberBean("117EA040-ECA2-4B05-A70D-9EFEA6346796","Marcus wo", "男",
		// "7782406836","A","106","110","1號1樓","Marcuswo@Foodmail.com","0910111111");
		// account_UID, member_ID, name, gender, tel, GUAR_CT, GUAR_AR,
		// GUAR_ROAD, GUAR_NO, email2, cel, insdate
		// dao.insert(beanIns);
		// System.out.println(beanIns);

		// update
		// MemberBean update = dao.update("Marcus
		// Lo",null,"男","7782406836","A","106","110","1號1樓","Marcuslo@Foodmail.com","0910111111",null,"46886F5D-34AE-4F43-9CB5-79BF388535A6");
	...
	private static final String STATUSUPDATE = "update seller_visitor set Seller_status=? where account_UID=?";

	//
	public List statusUpdate(String Seller_status, String account_UID) {
