...
//然後傳回給提出請求的瀏覽器
@WebServlet("/_08_RandomAD/getImage")
public class GetImageFromDB extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			DataSource ds = (DataSource) context.lookup("java:comp/env/8691");
			...
			// }
			pstmt = conn.prepareStatement("SELECT img from randomAD where id = ?");
